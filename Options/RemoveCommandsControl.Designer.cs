...
{
	partial class RemoveCommandsControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Select commands to remove:";
			// 
			// listBox1
			// 
			...
			this.button1.Click += new System.EventHandler(this.OnRemoveCommands);
			// 
			// RemoveCommandsControl
			// 
			...
			this.Name = "RemoveCommandsControl";
